...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    /**
     * Este metodo crea un evento en el cual permite al usuario del sistema
     * poder realizar modificaciones en la informacion de usuarios ya
     * registrados
     *
     * @param evt
     */
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        //Comprobacion si el campo esta vacio
        if (mail.equals("")) {
        ...
        //Realizando modificaciones cuando los campos esten llenos
        if (validacion == 0) {
            if (permisos_cmb == 1) {
